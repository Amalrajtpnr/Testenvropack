    ...
    <div id="home" className="lg:w-full sm500:w-full sm300:w-full lg:h-[100vh] sm300:h-[110vh] sm500:h-[30vh]  flex lg:flex-row sm500:flex-row sm300:flex-col lg:items-start sm500:items-start sm300:items-center lg:justify-end sm500:justify-end sm300:justify-between lg:relative sm500:relative sm300:relative ">
      ...
      <div className="lg:w-[58%] sm300:w-full sm500:w-[55%] lg:h-full sm500:h-full sm300:min-h-[50%] flex flex-col items-center justify-center  ">
        <div className="lg:w-[85%] sm500:w-[90%] sm300:w-[85%]  lg:h-full sm300:h-full flex flex-col lg:items-start sm300:items-center sm500:items-start lg:justify-end sm300:justify-center sm500:justify-end   ">
          <h1 className="lg:text-[45px] sm300:text-[20px] sm500:text-[25px] lg:text-left sm300:text-center sm500:text-left font-bold  font-Encode">
            We take immense pride in being your trusted partner for all your
            packaging needs
          </h1>
          <h1 className="lg:text-[25px] sm300:text-[15px] sm500:text-[18px] lg:text-left sm300:text-center sm500:text-left  font-light  lg:mt-2 sm300:mt-0 sm500:mt-0">
